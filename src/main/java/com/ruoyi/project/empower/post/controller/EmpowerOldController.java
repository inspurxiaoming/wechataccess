 ...
 */
@Controller
@RequestMapping("/empower/old-post")
public class EmpowerOldController extends BaseController {
    private String prefix = "empower/empower/old-post";
